...
// Pass 0
//--------------------------------------------------------------//
string UVAnimation_Pass_0_Model : ModelData = ".\\ShaderProgramming\\09_UVAnimation\\torus.x";
...
VS_OUTPUT UVAnimation_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   ...
   float cosTime = fWaveHeight
   * cos(fTime * fSpeed + Input.UV.x * fWaveFrequency);
   ...
   Output.UV = Input.UV + float2(fTime * fUVSpeed, 0);
...
float4 UVAnimation_Pass_0_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR0
{   
